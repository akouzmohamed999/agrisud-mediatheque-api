...
public class DaoConstant {
	...
	public static final String LIST_THEMATIC_SUPPORT_ID = "list_thematic_support_id";
	public static final String SUPPORT_ID = "support_id";
	public static final String LIST_COUNTRY_SUPPORT_ID = "list_country_support_id";
	public static final String COUNTRY_CODE = "country_code";
	public static final String PATH_SUPPORT = "path_support";
	...
	public static final String STATISTIC_MEDIA_ID = "statistic_media_id";
	public static final String ACTION = "action";
	public static final String DATE_ACTION = "date_action";
}
